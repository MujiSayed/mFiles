...
var peer = exec('forever start src/peerserver.js', function(error, stdout, stderr) {
    if (error !== null) {
        console.log('exec error: ', error);
    } else {
        console.log("peer server started successfully");
        console.log("Starting email server...");
        var email = exec('forever start email.js', function(error, stdout, stderr) {
            if (error !== null) {
                console.log('exec error: ', error);
            } else {
                console.log("email server started successfully");
                console.log("Starting mFile server...");
                var mfiles = exec('forever start mFiles.js', function(error, stdout, stderr) {
                    if (error !== null) {
                        console.log('exec error: ', error);
                    }
                });
        ...
        email.on('message', function(message) {
            console.log(message);
        });
